...
#load questions
Q1_img = pygame.image.load('quiz_trial2/assets/questions/Q1.png').convert_alpha()
Q2_img = pygame.image.load('quiz_trial2/assets/questions/Q2.png').convert_alpha()
Q2_img = pygame.image.load('quiz_trial2/assets/questions/Q3.png').convert_alpha()
