...
qnum = 1
points = 0
class Question_1(Q1_img, yes_button, no_button, Button):
    screen.blit(Q1_img, ((SCREEN_WIDTH/2) - 225, 200))
    if yes_button.draw() == False:
        points
    if no_button.draw() == True:
        points += 1
    kill()
...
#Button(questions[qnum-1][1][0], command = on_false)
#Button(questions[qnum-1][1][0], command = on_right)
